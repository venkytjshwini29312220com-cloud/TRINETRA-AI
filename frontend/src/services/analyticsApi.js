...
export async function getAnalyticsSummary(investigationId = 1) {
...
export async function getPatterns(investigationId = 1, entityId = null) {
...
export async function getInvestigationSummary(investigationId = 1) {
  const response = await api.get(
    `/analytics/investigations/${investigationId}/summary`
  );
